...
import { Info, ArrowRight, Shield, TrendingUp, Wallet, Key, PiggyBank } from 'lucide-react';
            ...
            <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-10">
                ...
                <div className={`${colors.cardBg} p-6 rounded-2xl shadow-md ${colors.cardBorder}`}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <ul className={`${typography.body} ${colors.textSecondary} list-disc list-inside`}>
                                <li><Link to="https://coin.z.com/jp/stacking/" target="_blank" className="text-[#3B82F6] hover:text-[#2b6cb0] inline-flex items-center group"><strong className="font-semibold">GMOコイン 積立</strong><ArrowRight className="ml-1 h-4 w-4" /></Link>: 毎日積み立て、毎月積み立てなど、 гибкиеなプランが豊富。</li>
                ...
                <div className={`${colors.cardBg} p-6 rounded-2xl shadow-md ${colors.cardBorder}`}>
                    ...
                    <ul className={`${typography.body} ${colors.textSecondary} list-disc list-inside space-y-2`}>
                        ...
                        <li><strong className="font-semibold">リスク管理の徹底:</strong>  投資には常にリスクが伴います。余剰資金での投資を心がけ、無理な инвестированиеは避けましょう。</li>
                    </ul>
                    <div className="mt-5 text-right">
                        <Link
                            to="/analysis-news"
                ...
                {/* CTA：シミュレーターへの導線 */}
                <div className="text-center mt-10"> {/* mt-8 から mt-10 へ */}
